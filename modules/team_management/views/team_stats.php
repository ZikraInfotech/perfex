   ...
   <div class="content flex flex-col gap-10">
        ...
        <div class="w-full">
            ...
            <div class="flex flex-col w-full p-4 rounded-2xl bg-white shadow-[4px_4px_0_0] hover:shadow-none transition-all duration-500 border border-solid">
                ...
                <div class="grid lg:grid-cols-3 grid-cols-2 gap-2">
                    ...
                    <div class="w-full h-36 flex flex-col items-center justify-center bg-blue-700 rounded text-white text-center shadow-[4px_4px_0_0] shadow-neutral-500 hover:shadow-none transition-all duration-500 gap-2">
                        <div class="text-xl">Total Time Today:</div>
                        <div class="text-3xl"><?php echo convertSecondsToRoundedTime($timers->todayTime); ?></div>
                    </div>

                    <div class="w-full h-36 flex flex-col items-center justify-center bg-pink-500 rounded text-white text-center shadow-[4px_4px_0_0] shadow-neutral-500 hover:shadow-none transition-all duration-500 gap-2">
                        <div class="text-xl">Time Yesterday:</div>
                        <div class="text-3xl"><?php echo convertSecondsToRoundedTime($timers->yesterdayTime); ?></div>
                    </div>

                    <div class="w-full h-36 flex flex-col items-center justify-center bg-emerald-600 rounded text-white text-center shadow-[4px_4px_0_0] shadow-neutral-500 hover:shadow-none transition-all duration-500 gap-2">
                        <div class="text-xl">Time This Week:</div>
                        <div class="text-3xl"><?php echo convertSecondsToRoundedTime($timers->weekTime); ?></div>
                    </div>

                    <div class="w-full h-36 flex flex-col items-center justify-center bg-lime-600 rounded text-white text-center shadow-[4px_4px_0_0] shadow-neutral-500 hover:shadow-none transition-all duration-500 gap-2">
                        <div class="text-xl">Total Ongoing Tasks:</div>
                        <div class="text-3xl"><?php echo $timers->totalOngoingTasks; ?></div>
                    </div>

                    <div class="w-full h-36 flex flex-col items-center justify-center bg-purple-600 rounded text-white text-center shadow-[4px_4px_0_0] shadow-neutral-500 hover:shadow-none transition-all duration-500 gap-2">
                        <div class="text-xl">Most efficient Member:</div>
                    ...
                    <div class="w-full h-36 flex flex-col items-center justify-center bg-rose-600 rounded text-white text-center shadow-[4px_4px_0_0] shadow-neutral-500 hover:shadow-none transition-all duration-500 gap-2">
                        <div class="text-xl">Most Time Put in by:</div>
                        <div class="text-2xl flex flex-row items-center gap-2">
        ...
        <div class="w-full">
            ...
            <div class="p-4 bg-white">
                ...
                <table id="tasks-table-due" class="display">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Assigned To:</th>
                ...
                <table id="tasks-table-due-today" class="display">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Assigned To:</th>
                ...
                <table id="tasks-table-all" class="display">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Assigned To:</th>
